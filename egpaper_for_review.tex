...
\begin{enumerate}
    ...
    Many descriptors have been proposed in the literature \ayellet{citations for three major ones}.
    We are using the \ayellet{ FPFH~\cite{}}  due to being robust to small deformations and partiality of data, yet sensitive to symmetrical flips. \ayellet{why is this sensitivity important?}
    \item
    ...
    To extract them, we start from the extremities, which are silent points.
    ...
    A point that maximizes the similarity function that realizes tthis idea is considered the corresponding point.
