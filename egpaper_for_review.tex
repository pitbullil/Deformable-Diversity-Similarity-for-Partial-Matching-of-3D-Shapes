...
It follows from this that the smaller the pieces we are trying to match will be, the higher the likelihood of pairwise distance to preserve.

Therefore, our algorithm, which is illustrated inFigure XXX, consists of the following steps.
\begin{enumerate}
    \item 
    Pre-processing.
    \begin{itemize}
