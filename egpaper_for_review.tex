...
\begin{enumerate}
    ...
    \item
    {\bf Patch extraction.} 
    Once the set of representing samples of \ayellet{M} is constructed, a sub-surface is extracted around each point, defined to be the geodesic disc of radius $R_T$ around it.
