...
Points that share a NN with $\kappa$ other points will have their contribution to the similarity score attenuated by $e^{(1-\kappa)}$. The comparison, illustrated in Figure~\ref{fig:OriginalDDIS} shows a significant improvement over the original formulation, stemming from a higher robustness to partiality.}
